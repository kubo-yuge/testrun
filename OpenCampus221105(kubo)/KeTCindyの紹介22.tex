...
直線をはさむ2点を見てみよう。\par
\begin{layer}{80}{0}
\putnotese{7}{7}{\input{fig/対称移動1.tex}}
\end{layer}\par
...
直線をはさむ2点の座標に注目!!\par
\begin{layer}{80}{0}
\putnotese{3}{7}{\input{fig/対称移動3.tex}}
\end{layer}\par
\vspace{15\baselineskip}
...
\begin{layer}{80}{0}
\putnotese{3}{7}{\input{fig/対称移動4.tex}}
\end{layer}\par
\vspace{15\baselineskip}
...
\begin{layer}{80}{0}
\putnotese{3}{7}{\input{fig/Heart.tex}}
\end{layer}\par
...
\begin{layer}{80}{0}
\putnotese{18}{4}{\scalebox{.45}{\input{kamirinOspSample201003.tex}}}
\end{layer}\par
\vspace{11\baselineskip}
