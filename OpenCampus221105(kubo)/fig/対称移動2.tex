%%% /Users/kumac21/DataKubo_Mac21/予定とメモなど/予定とメモ（学内）/予定：学内21/学事予定21/オープンキャンパス21秋/出品(久保)/fig/対称移動2.tex 
%%% Generator=対称移動2.cdy 
{\unitlength=8mm%
\begin{picture}%
(7.45,7.45)(-2.45,-2.45)%
\special{pn 8}%
%
\special{pa  -386   772}\special{pa  -378   756}\special{pa  -315   630}\special{pa  -252   504}%
\special{pa  -189   378}\special{pa  -126   252}\special{pa   -63   126}\special{pa     0    -0}%
\special{pa    63  -126}\special{pa   126  -252}\special{pa   189  -378}\special{pa   252  -504}%
\special{pa   315  -630}\special{pa   378  -756}\special{pa   441  -882}\special{pa   504 -1008}%
\special{pa   567 -1134}\special{pa   630 -1260}\special{pa   693 -1386}\special{pa   756 -1512}%
\special{pa   787 -1575}%
\special{fp}%
...
\special{fp}%
\special{pa -309 -945}\special{pa -309 -946}\special{pa -309 -946}\special{pa -309 -947}%
\special{pa -310 -948}\special{pa -310 -948}\special{pa -311 -949}\special{pa -311 -949}%
\special{pa -312 -950}\special{pa -312 -950}\special{pa -313 -951}\special{pa -314 -951}%
\special{pa -315 -951}\special{pa -315 -951}\special{pa -316 -951}\special{pa -317 -951}%
\special{pa -318 -950}\special{pa -318 -950}\special{pa -319 -949}\special{pa -319 -949}%
\special{pa -320 -948}\special{pa -320 -948}\special{pa -321 -947}\special{pa -321 -946}%
\special{pa -321 -946}\special{pa -321 -945}\special{pa -321 -944}\special{pa -321 -943}%
\special{pa -321 -943}\special{pa -320 -942}\special{pa -320 -941}\special{pa -319 -941}%
\special{pa -319 -940}\special{pa -318 -940}\special{pa -318 -939}\special{pa -317 -939}%
\special{pa -316 -939}\special{pa -315 -939}\special{pa -315 -939}\special{pa -314 -939}%
\special{pa -313 -939}\special{pa -312 -939}\special{pa -312 -940}\special{pa -311 -940}%
\special{pa -311 -941}\special{pa -310 -941}\special{pa -310 -942}\special{pa -309 -943}%
\special{pa -309 -943}\special{pa -309 -944}\special{pa -309 -945}\special{pa -309 -945}%
\special{sh 1}\special{ip}%
\special{pa  -309  -945}\special{pa  -309  -946}\special{pa  -309  -946}\special{pa  -309  -947}%
\special{pa  -310  -948}\special{pa  -310  -948}\special{pa  -311  -949}\special{pa  -311  -949}%
\special{pa  -312  -950}\special{pa  -312  -950}\special{pa  -313  -951}\special{pa  -314  -951}%
...
\special{pa  -313  -939}\special{pa  -312  -939}\special{pa  -312  -940}\special{pa  -311  -940}%
\special{pa  -311  -941}\special{pa  -310  -941}\special{pa  -310  -942}\special{pa  -309  -943}%
\special{pa  -309  -943}\special{pa  -309  -944}\special{pa  -309  -945}%
\special{fp}%
\special{pa   945  -315}\special{pa  -315  -945}%
\special{fp}%
\special{pa   626  -448}\special{pa   648  -490}%
\special{fp}%
\special{pa   612  -455}\special{pa   633  -497}%
\special{fp}%
\special{pa     4  -812}\special{pa   -18  -770}%
\special{fp}%
\special{pa    18  -805}\special{pa    -4  -763}%
\special{fp}%
...
\settoheight{\Height}{P$(3,1)$}\settodepth{\Depth}{P$(3,1)$}\setlength{\Height}{\Depth}%
\put(3.1875000,1.0625000){\hspace*{\Width}\raisebox{\Height}{P$(3,1)$}}%
%
\settowidth{\Width}{Q$(-1,3)$}\setlength{\Width}{-1\Width}%
\settoheight{\Height}{Q$(-1,3)$}\settodepth{\Depth}{Q$(-1,3)$}\setlength{\Height}{\Depth}%
\put(-1.0625000,3.1875000){\hspace*{\Width}\raisebox{\Height}{Q$(-1,3)$}}%
%
\settowidth{\Width}{$y=2x$}\setlength{\Width}{-0.5\Width}%
\settoheight{\Height}{$y=2x$}\settodepth{\Depth}{$y=2x$}\setlength{\Height}{\Depth}%
\put(3.0000000,4.0625000){\hspace*{\Width}\raisebox{\Height}{$y=2x$}}%
%
